nothing-rhymes-with-nougat: Nougat Restoration Project
=========================================================

This repository contains reconstructed `repo` manifests of pre-release Android 7.0/7.1 ("Nougat") builds.

Only one build has been reconstructed at the moment.
